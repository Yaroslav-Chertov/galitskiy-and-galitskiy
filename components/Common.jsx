import Index from '#_/components/pages/index.jsx';
import About from '#_/components/pages/about.jsx';
import Wines from '#_/components/pages/wines.jsx';
import WineDetails from '#_/components/pages/wine-details.jsx';
import Popups from '#_/components/Popups.jsx';
import Summary from '#_/components/Summary.jsx';
// Данные отсюда https://galitskiy-galitskiy.ru/local/ajax/data
    ...
    return (
        <>
            {/*
                ...
                is-about - О нас
                is-wines - Вина
                is-wine - Вино детальная
            */}
            <div id="app">
                <div class="header" style="height: 730px;">
                    <div class="burger" >
                    ...
                    <div class="menu" style="top: 365px;">
                        <div class="menu-left">
                            <a href="/about/" class="menu-main link--hover" data-elts="fontSize">
                                <span>О нас</span>
                            </a>
                            <div class="submenu">
                                <a href="#blog">
                        ...
                        <div class="menu-right">
                            <a href="/wines/" class="menu-main link--hover" data-elts="fontSize">
                                <span>Вина</span>
                            </a>
                            <div class="submenu">
                                <a href="#buy">
                    ...
                    <div class="info">
                        ...
                        <div class="i" data-open-popup="summary">
                ...
                <div class="holder" id="holder" data-elt="holder">
                    ...
                    <div data-page="root">
                        {/* WARN: здесь компоненты страниц */}
                        <Index data={data} />
                        <About data={data} />
                        <Wines data={data} />
                        <WineDetails data={data} />
                        <Summary data={data} />
                    </div>
                </div>

                <div class="popup" id="blog">
                    <div class="popup__title">Блог</div>
                    ...
                    <div class="popup__content">
                        <div class="blog-posts">
                            {data.blog.map((b) => {
                                return (
                                    <a href={`#blog/${b.code}`} class="blog-post" data-detail={b.code}>
                                        <span class="blog-post__image">
                                            <img data-src={b.pic} alt={b.title} />
                                        </span>
                                        <span class="blog-post__info">
                                            <span class="blog-post__date">{b.date}</span>
                                            <span class="blog-post__type">{b.type}</span>
                                            <span class="blog-post__title">{b.title}</span>
                                        </span>
                                    </a>
                                );
                            })}
                    ...
                    {data.blog.map((b) => {
                        return (
                            <div class="hide" id={b.code}>
                                <div class="detail__header">
                                    <div class="detail__close js-popup-close">
                                        <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M10 23.818L24.3182 9.49982L25 10.1816L10.6819 24.4998L10 23.818Z" fill="white"></path>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M24.3198 24.5L10.0017 10.1818L10.6835 9.5L25.0016 23.8181L24.3198 24.5Z" fill="white"></path>
                                        </svg>
                                    </div>
                                </div>
                                ...
                                <div class="detail__share">
                                    <a href={`https://galitskiy-galitskiy.ru/about/#blog/${b.code}`} data-copy={`https://galitskiy-galitskiy.ru/about/#blog/${b.code}`}>
                                    ...
                                    <a href="https://t.me/share/url?url=https%3A%2F%2Fgalitskiy-galitskiy.ru%2Fabout%2F%23blog%2F${b.code}&amp;text=Семейный фотоальбом. Зимняя поездка фотографа Макса Авдеева на терруар «Красная Горка»" target="_blank">
                                        <svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M12.1818 11.9545C11.9506 12.0385 11.6912 12.0043 11.49 11.8675C10.2238 11.0017 7.99132 9.4303 7.99132 9.4303L6.05636 11.1841C5.92199 11.3059 5.72949 11.3533 5.5495 11.3083C5.36888 11.2627 5.232 11.1307 5.17263 10.9627C4.69952 9.6247 3.79204 6.9937 3.79204 6.9937C3.79204 6.9937 1.85021 6.4027 0.370865 5.9779C0.156495 5.9161 0.00774848 5.7319 0.000248652 5.5195C-0.00662619 5.30769 0.129621 5.1145 0.338991 5.04009C2.09563 4.41608 5.20546 3.29999 8.12486 2.25224C10.6876 1.33249 13.1036 0.4654 14.3287 0.030089C14.4987 -0.030511 14.6893 0.0018887 14.8268 0.114089C14.9643 0.226289 15.0268 0.400889 14.9893 0.56889C14.7466 1.66298 14.3057 3.71433 13.8553 5.8094C13.3881 7.98261 12.9109 10.2029 12.6343 11.4505C12.5831 11.6803 12.4131 11.8699 12.1818 11.9545Z" fill="black"></path>
                                        </svg>
                                    </a>
                                </div>

                                <div class="detail__cover" style={`background-image: url('${b.detail}');`}></div>

                                <div class="detail__content">
                                    <div class="blog-post__info">
                                        <div class="detail__date"> {b.date}</div>
                                        <div class="blog-post__type">{b.type}</div>
                                        <div class="blog-post__title">{b.title}</div>
                                    </div>
                                    <div class="detail__text">{b.text}</div>
                                </div>
                            </div>
                        );
                    })}
                ...
                <div class="summary-popup" data-popup="summary">
                    <div class="summary">
                        <div class="summary-i">
                            <svg width="9" height="18" viewBox="0 0 9 18" fill="none" xmlns="http://www.w3.org/2000/svg" alt="">
                                <path d="M6.1282 5.24018H5.7682C5.0962 5.72018 4.1602 5.96018 2.3602 5.96018H0.200195V6.44018H3.2002C4.2802 6.44018 4.2562 6.56017 3.8482 7.52018L2.1442 11.7442C1.4962 13.2562 1.1842 14.1682 1.1842 15.0082C1.1842 16.8082 2.6002 17.3602 3.5602 17.3602C5.0722 17.3602 6.5122 16.1602 7.9762 13.4242L8.2402 12.9442L7.8082 12.7042L7.5442 13.1842C6.3922 15.3442 5.1202 16.7602 3.8002 16.7602C3.0802 16.7602 2.2882 16.4002 2.2882 15.2002C2.2882 14.6002 2.5282 14.0242 3.2482 12.2722L6.1282 5.24018ZM5.2402 1.88017C5.2402 2.55217 5.7682 3.08017 6.4402 3.08017C7.1122 3.08017 7.6402 2.55217 7.6402 1.88017C7.6402 1.20817 7.1122 0.680176 6.4402 0.680176C5.7682 0.680176 5.2402 1.20817 5.2402 1.88017Z" fill="black"></path>
                        ...
                        <div class="summary-footer">
                            <div class="summary-menu">
                                <a href="/about/" class="link--hover" data-elts="fontSize">
                                    <span>О нас</span>
                                </a>
                                <a href="/wines/" class="link--hover">
                                    <span>Вина</span>
                                </a>
                    ...
                    <div class="summary-close" data-elts="closePopup">
                        <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M26 1L1 26M26 26L1 1" stroke="black"></path>
                        </svg>
                    </div>
                </div>

                <div class="mobile-menu" data-popup="nav">
