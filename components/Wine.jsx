export default ({ wine, similarWines }) => {
    if (!wine?.name) return
            ...
            <div class="content-gallery">
                ...
                <div class="wine-gallery">
                    <div class="wine-images">
                        <div class="wine-image is-active">
                            <img src={wine.detail_pic} alt={wine.name} />
                        </div>

                        {wine.magnum && <div class="wine-image">
                            <img src={wine.magnum} alt={wine.name} />
                        </div>}
                    ...
                    <div class="wine-bottles">
                        <div class="wine-bottle is-active" data-id="0">standart</div>
                        <div class="wine-bottle" data-id="1">magnum</div>
                    </div>
                    }
                </div>
            </div>
            <div class="content content--wine panel-container">
                <div class="panel-holder is-active" data-id="panel-wine">
                    <div class="panel panel--white panel--dark">
                        <div class="header">
                            <div class="burger" >
                            ...
                            <div class="menu">
                                <div class="menu-left">
                                    <a href="/about/" class="menu-main link--hover">
                                        <span>О нас</span>
                                    </a>
                                    <div class="submenu">
                                        <a href="#blog">
                                ...
                                <div class="menu-right">
                                    <a href="/wines/" class="menu-main link--hover">
                                        <span>Вина</span>
                                    </a>
                                    <div class="submenu">
                                        <a href="#buy">
                ...
                <div class="wine" data-elts="wine">
                    <div class="wine-preview" data-innerhtml="true">
                        {wine.preview}
                    </div>
                    <div class="wine-years">
                        <div class="wine-years-title">Год урожая</div>
                        <div class="wine-years-tabs">
                            {wine.years.map((y, i) => (
                                <div class={i === 0 ? "is-active" : ""} data-elts="tabBtn" data-tab={`tab${i}`} data-group="wineYear">
                                    {y.year || "-"}
                                </div>
                            ))}
                        </div>

                        <div class="wine-landing" data-elt="wineLanding">
                            <a href="https://grand-jete.galitskiy-galitskiy.ru" target="_blank" style="color: rgb(0, 0, 0); display: inline-block; position: relative; text-decoration: none;">
                                <span style="color: rgb(255, 255, 255);">Сайт Grand Jeté</span>
                            </a>
                        </div>
                    </div>

                    {wine.years.map((wine, i) => {
                        return (
                            <div class={`wine-detail ${i === 0 ? "is-active is-animate" : ""}`} data-tab={`tab${i}`}>
                                <div class="wine-left">
                                    <div class="wine-params">
                                        {wine.params.map((p) => (
                                            <div>
                                                <span>{p.key}</span>
                                                <span>{p.value}</span>
                                    ...
                                    <div class="wine-where">
                                        <a href="#buy" class="link--hover-2">
                                            <span>Где купить</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="wine-right">
                                    <div class="wine-notes">
                                        Записки главного винодела проекта Алексея Толстого <div class="wine-notes-i">i</div>
                                        <div class="wine-notes-hint">Каждый год имеет свои погодные особенности, которые влияют на&nbsp;созревание винограда. Так винтажи разных годов могут отличаться друг от&nbsp;друга, и&nbsp;Алексей Толстой отражает это в&nbsp;дегустационных записках.</div>
                                    </div>

                                    <div class="wine-text">
                                        <div class="wine-year" data-year={wine.year} data-innerhtml="true">
                                            {wine.text}
                                        </div>
                                    </div>
                                    <div class="wine-where">
                    ...
                    <div class="swiper wine-other">
                        <h2>Другие вина</h2>
                        <div class="wine-other-nav">
                            <div class="wine-other-prev">
                                <svg width="21" height="17" viewBox="0 0 21 17" xmlns="http://www.w3.org/2000/svg" fill="none">
                                    <path d="M20.7588 1.24219L1.48168 8.50025L20.7588 15.7583" stroke="black"></path>
                                </svg>
                            </div>

                            <div class="wine-other-next">
                                <svg width="21" height="17" viewBox="0 0 21 17" xmlns="http://www.w3.org/2000/svg" fill="none">
                                    <path d="M0.241211 15.7578L19.5183 8.49975L0.24121 1.24169" stroke="black"></path>
                                </svg>
                            </div>
                        </div>
                            ...
                            <div class="swiper-wrapper">
                                {similarWines.map((sw) => (
                                    <div class="swiper-slide">
                                        <a href={`/wines/${sw.code}`} class="catalog-item">
                                            <span class="catalog-item-img">
                                                <span style={`background-image: url('${sw.pic}');`}>
                                                    <span></span>
                                                </span>
                                            </span>
                                            <span class="wine-title">{sw.name}</span>
                                        </a>
                                    </div>
                                ))}
                            </div>
