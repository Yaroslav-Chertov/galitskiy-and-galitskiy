...
const Wines = ({ data }) => {
    ...
    return (
        <div style="display: none;" data-route="wines" data-elts="winesPage">
            <div class="main">
                <div class="content-header" data-elt="winesHeader">
                    <span class="for-wines">
                        <img data-src="/assets/top-wines.jpg" alt="" />
                    </span>
                </div>
                <div class="content panel-container panel-to-bottom" data-elt="panelOverlap">
                    <div class="panel-holder is-active" data-id="panel-wines">
                        <div class="panel panel--dark" data-elt="panelHeight">
                            <div class="header">
                                <div class="burger" >
                                ...
                                <div class="menu">
                                    ...
                                    <div class="menu-right" data-elts="menu-right-overlap">
                                        <a aria-current="page" href="/wines/" class="menu-main link--hover">
                                            <span>Вина</span>
                                        </a>
                                        <div class="submenu">
                                            <a href="#buy">
                    ...
                    <div class="catalog">
                        <div class="filter">
                            ...
                            <label class="">
                                <input type="radio" name="type" value="Красное" />
                                Красное
                            </label>
                            <label class="">
                                <input type="radio" name="type" value="Белое" />
                                Белое
                            </label>
                            <label class="">
                                <input type="radio" name="type" value="Розовое" />
                                Розовое
                            </label>
                            <label class="">
                                <input type="radio" name="type" value="Игристое" />
                                Игристое
                            </label>
                            <label class="">
                                <input type="radio" name="type" value="Айсвайн" />
                                Айсвайн
                            </label>
                            <label class="">
                                <input type="radio" name="type" value="Магнумы" />
                                Магнумы
                            </label>
                        </div>

                        {data.wines.items.map((wine) => (
                            <a
                                href={`/wines/${wine.code}/`}
                                //href="#"
                                class="catalog-item"
                                key={wine.id}
                                //data-code={wine.code}
                                ...
                                <span class="catalog-item-img">
                                    <span style={`background-image: url('${wine.pic}');`}>
                                        <span></span>
                                    </span>
                                </span>
                                <span class="wine-title">{wine.name}</span>
                            </a>
                        ))}
                    </div>
                </div>
