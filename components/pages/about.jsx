...
const About = ({ data }) => {
    return (
        <div style="display: none;" data-route="about">
            <div class="main" /* style="padding-bottom: 970px;" */>
                {/* TODO: паддинг для футера */}
                <div class="content-header" data-elt="aboutHeader">
                    <span class="for-about">
                        <img data-src="/assets/top-about.jpg" alt="" />
                    </span>
                </div>
                <div class="content">
                    <div class="about-top panel-container">
                        <div class="panel-holder is-active" data-id="panel-about-top">
                            <div class="panel panel--dark">
                                <div class="header">
                                    ...
                                    <div class="menu">
                                        <div class="menu-left" data-elts="menu-left-overlap">
                                            <a aria-current="page" href="/about/" class="menu-main link--hover">
                                                <span>О нас</span>
                                            </a>
                                            <div class="submenu">
                                                <a href="#blog">
                                        ...
                                        <div class="menu-right" data-elts="menu-right-overlap">
                        ...
                        <div class="about-text">{data.about.text}</div>
                        <div class="swiper swiper-horizontal swiper-pointer-events about-timeline">
                            <div class="swiper-wrapper">
                                {data.about.timeline.map((tl, i) => (
                                    <div class={`swiper-slide about-time ${i === 0 ? " about-time--first" : ""}`}>
                                        <div class="about-time__title">{tl.title}</div>
                                        {tl.gif && (
                                            <div class="about-time__pic">
                                                <img data-src={tl.gif} />
                                            </div>
                                        )}
                                        <div class="about-time__desc">{tl.text}</div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div class="about-team">
                            {data.about.team.map((person, i) => {
                                return (
                                    <div class={`about-person${i === 2 ? " about-person--third" : ""}`}>
                                        <div class="about-person__photo">
                                            {" "}
                                            <img data-src={person?.photo} alt={person?.alt} />{" "}
                                        </div>
                                        <h2 class="about-person__name" style="margin-block-end: auto;">
                                            {person?.title}
                                        </h2>
                                        <div class="about-person__position">{person?.position}</div>
                                        <div class="about-person__text"> {person?.text} </div>
                                    </div>
                                )
                            })}
                        </div>
                    </div>
                    <div class="about-gallery panel-container" data-elts="panelAboutGallery">
                        ...
                        <div class="swiper swiper-horizontal swiper-pointer-events about-slides">
                            <div class="swiper-wrapper">
                                {data.about?.gallery?.map((gal, i, arr) => {
                                    return (
                                        <div class="swiper-slide about-slide">
                                            <div class="about-slide__image" style={`background-image: url('${gal.slide}');`}></div>
                                            <div class="about-slide__info">
                                                <span>
                                                    {i + 1} / {arr.length}
                                                </span>
                                            </div>
                                            <div class="about-slide__text">{gal.text}</div>
                                        </div>
                                    )
                                })}
                            </div>

                            <div class="about-slide__info js-about-slide__info">
                                <span>1 / 7</span>
                            </div>
                            <div class="about-slide__text js-about-slide__text">{data.about.gallery[0].text}</div>
                            <div class="swiper-button-prev"></div>
                            <div class="swiper-button-next"></div>
                        </div>
                    </div>
                    <div class="about-quote panel-container panel-to-bottom" data-elts="aboutQuote">
                        <div class="panel-holder is-active" data-id="panel-about-quote">
                            <div class="panel panel--dark">
                                <div class="header">
                                    <div class="burger" >
                                        <svg width="35" height="17" viewBox="0 0 35 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="about-quote-item">
                            <div class="about-quote-pic">
                                <img data-src={data.about.quote.photo} alt={data.about.quote.alt} />
                            </div>
                            <div class="about-quote-text">{data.about.quote.text}</div>
                            <div class="about-quote-link">
                                <a href="https://t.me/galitskiy_galitskiy/75" target="_blank" class="link--hover-2">
                                    <span>{data.about.quote.title}</span>
                                </a>
                            </div>
                        </div>
                    </div>
